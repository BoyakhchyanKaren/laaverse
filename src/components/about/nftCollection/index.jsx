...
const Ellipse2 = styled.img`
  ...
  height: 16px;
  position: relative;
  margin: 0px 37px 274px 0px;
`;
const Ellipse8 = styled.img`
  width: 7px;
  height: 7px;
  position: relative;
  margin: 0px 25px 152px 0px;
`;
...
const FlexColumn2 = styled.div`
  ...
  justify-content: flex-end;
  align-items: flex-start;
  padding: 24px 44px 24px 43px;
  background-size: cover;
  background-image: url("https://file.rendit.io/n/oh1egRt6zY5Kj6tw67VD.svg");
`;
